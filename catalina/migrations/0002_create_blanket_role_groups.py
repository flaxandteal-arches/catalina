...
per-resource permission rows; the ``catalina.permissions.blanket_roles`` framework
grants resource-instance access by group membership when CATALINA_BLANKET_ROLES is
