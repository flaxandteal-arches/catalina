                ...
                if (Array.isArray(componentsNode)) {
                    self.components(
                        componentsNode.map((x) => {
                            const rawConstructionPhase = self.getRawNodeValue(
                                x,
                                {
                                    testPaths: [
                            ...
                            const constructionPhases = (
                                Array.isArray(rawConstructionPhase)
                                    ? rawConstructionPhase
                                    : rawConstructionPhase
                                      ? [rawConstructionPhase]
                                      : []
                            ).map((p) => ({
                                link: self.getResourceLink(p),
                                text: self.getNodeValue(p),
                            }));
                ...
                if (self.dataConfig.usePhase) {
                    ...
                    self.usePhases(
                        usePhaseNode.map((x) => {
                            ...
                            const useEvidence = self.getNodeValue(x, {
                                testPaths: [
                                    [
                                        "use phase classification",
                                        "use phase evidence type",
                                    ],
                                    ["use phase classification", "evidence type"],
                                ],
                            });
