    ...
    return ko.components.register('area-report', {
        viewModel: function(params) {
            ...
            self.descriptionDataConfig = {
                ...
                sourceReferenceWork: 'source reference work'
            };

            self.resourceDataConfig = {
                files: 'digital file(s)',
                activities: 'associated activities',
                consultations: 'associated field assessment',
            ...
            if(params.report.cards){
                ...
                self.nameCards = {
                    ...
                    appellativeStatus: self.cards?.['appellative status'],
                    whakapapaStatus: self.cards?.['whakapapa status']
                };

                self.descriptionCards = {
                    descriptions: self.cards?.['descriptions'],
                    citation: self.cards?.['bibliographic source citation'],
                    sourceReferenceWork: self.cards?.['source reference work']
                };
                ...
                self.classificationCards = {
                    ...
                    functionStatus: self.cards?.['function status'],
                    classificatoryStatus: self.cards?.['classification'],
                    type: self.cards?.['record type']
                };
                ...
                self.resourcesCards = {
                    ...
                    consultations: self.cards?.['associated field assessment'],
                    files: self.cards?.['associated digital file(s)'],
                    assets: self.cards?.['associated heritage places, areas and artefacts']
                };
                ...
                self.locationCards = {
                    ...
                    physicalLocativeStatus: self.cards?.['physical locative status']
                };

                self.protectionCards = {
                    designations: self.cards?.['designation and protection assignment'],
                    recordRegistryMembership: self.cards?.['record and registry membership'],
                    custodialStatus: self.cards?.['custodial status']
                };
