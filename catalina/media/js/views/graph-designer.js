...
var GraphDesignerView = BaseManagerView.extend({
    initialize: function(options) {
        ...
        // Populate the graph model's cardwidgets from the initial (translatable) page data.
        // Core only ever pushes appended-branch widgets here, so on initial load it is empty;
        // the graph tree needs the full set to resolve translated widget labels for display.
        if (data.cardwidgets) {
            viewModel.graphModel.get('cardwidgets')(data.cardwidgets);
        }
